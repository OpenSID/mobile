...
import 'package:opensid/core/auth/login/screen/login_screen.dart';
import 'package:opensid/core/splashscreen/screen/splashscreen.dart';
import 'package:opensid/modules/awal/screen/awal_screen.dart';
import 'package:opensid/modules/home/screen/home_screen.dart';
...
@MaterialAutoRouter(
  ...
  routes: <AutoRoute>[
    ...
    AutoRoute(path: '/mulai', page: AwalScreen),
